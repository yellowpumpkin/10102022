...
# Update
    def funcbtnhandleUpdateInfo(self):
        ...
        if (g_type == False or g_thick == False or g_wide == False  or g_long == False  ):
            if (g_type == False):
                QMessageBox.information(self, "Siam Kyohwa", "ไม่พบข้อมูลประเภทไม้ในฐานข้อมูล")
            elif (g_thick == False):
                QMessageBox.information(self, "Siam Kyohwa", "ไม่พบข้อมูลความหนาไม้ในฐานข้อมูล")
            elif (g_wide == False):
                QMessageBox.information(self, "Siam Kyohwa", "ไม่พบข้อมูลความกว้างไม้ในฐานข้อมูล")
            elif (g_long == False):
                QMessageBox.information(self, "Siam Kyohwa", "ไม่พบข้อมูลความยาวไม้ในฐานข้อมูล")
